...
\begin{enumerate}[itemsep=0mm]
	...
	\item The initial state of the environment is stored in \codeinline{init_field.dat} and can be re-generated using the \codeinline{init.py} file (except for the \codeinline{lorenz-v0} environment).
\end{enumerate}
