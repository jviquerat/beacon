...
\end{tikzpicture}
%%%%%%%%%%%%
\caption{\textbf{Score curves of \ppo when solving the \codeinline{burgers-v0} environment.} The dashed line indicates the reward obtained for the uncontrolled environment.} 
