...
\end{tikzpicture}
%%%%%%%%%%%%
\caption{\textbf{Score curves of \ppo and \dqn when solving the \codeinline{lorenz-v0} environment.} The dashed line indicates the reward obtained for the uncontrolled environment.} 
