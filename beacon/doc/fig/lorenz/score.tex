...
\end{tikzpicture}
%%%%%%%%%%%%
\caption{\textbf{Score curves for the \codeinline{lorenz-v0} environment} solved with \ppo and \dqn. The dashed line indicates the reward obtained for the uncontrolled environment.} 
