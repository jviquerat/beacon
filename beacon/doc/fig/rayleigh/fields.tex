...
\begin{subfigure}[t]{.22\textwidth}
	\centering
	\fbox{\includegraphics[width=\textwidth]{fig/rayleigh/t0.png}}
    	\caption{$t=0$}
	\label{fig:rayleigh_field_0}
\end{subfigure} \quad
\begin{subfigure}[t]{.22\textwidth}
	\centering
	\fbox{\includegraphics[width=\textwidth]{fig/rayleigh/t2.png}}
    	\caption{$t=2$}
	\label{fig:rayleigh_field_2}
\end{subfigure} \quad
\begin{subfigure}[t]{.22\textwidth}
	\centering
	\fbox{\includegraphics[width=\textwidth]{fig/rayleigh/t4.png}}
    	\caption{$t=4$}
	\label{fig:rayleigh_field_4}
\end{subfigure} \quad
\begin{subfigure}[t]{.22\textwidth}
	\centering
	\fbox{\includegraphics[width=\textwidth]{fig/rayleigh/t6.png}}
    	\caption{$t=6$}
...
\begin{subfigure}[t]{.22\textwidth}
	\centering
	\fbox{\includegraphics[width=\textwidth]{fig/rayleigh/t8.png}}
    	\caption{$t=8$}
	\label{fig:rayleigh_field_8}
\end{subfigure} \quad
\begin{subfigure}[t]{.22\textwidth}
	\centering
	\fbox{\includegraphics[width=\textwidth]{fig/rayleigh/t10.png}}
    	\caption{$t=10$}
	\label{fig:rayleigh_field_10}
\end{subfigure} \quad
\begin{subfigure}[t]{.22\textwidth}
	\centering
	\fbox{\includegraphics[width=\textwidth]{fig/rayleigh/t12.png}}
    	\caption{$t=12$}
	\label{fig:rayleigh_field_12}
\end{subfigure} \quad
\begin{subfigure}[t]{.22\textwidth}
	\centering
	\fbox{\includegraphics[width=\textwidth]{fig/rayleigh/t14.png}}
    	\caption{$t=14$}
