...
\begin{tikzpicture}[]
	...
	\node[scale=0.8] (bc_temp_top) at (0.2*\xaxis, \yaxis-1) {$\theta =-\frac{1}{2}$};
	\node (bc_top2) at (0.4*\xaxis, \yaxis) {};
	\draw[-stealth] (bc_temp_top) to[out=0,in=-90] (bc_top2);
	
	\node[scale=0.8] (bc_temp_bot) at (0.8*\xaxis, 1) {$\theta = \frac{1}{2}$};
