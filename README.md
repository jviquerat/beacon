...
- 27/08/25: added a separable version of `shkadov-v0`, in the fashion of the article from <a href="https://aip.scitation.org/doi/10.1063/1.5132378">Belus et al</a>. It relies on the separable process described in the <a href="https://github.com/jviquerat/dragonfly">dragonfly</a> library, and allows for a simple subclassing of the original environment with minimal modifications.
...
| `shkadov_separable-v0` | A separable version of the `shkadov-v0` environment. Can be run with significantly more actuators.                                                                                                                                                                                                                                                                                                                                                                      | <img width="300" alt="gif" src="beacon/msc/shkadov_separable.png"> |
...
| `sloshing-v0`          | The agent controls the acceleration of a tank containing a fluid in order to damp the sloshing movement initiated during an excitation phase. State vector is a downsampled mass flow rate vector. One episode represents 200 actions, and the training is made on 200000 transitions.                                                                                                                                                                                  | <img width="300" alt="gif" src="beacon/msc/sloshing.gif">          |
